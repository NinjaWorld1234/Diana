...
import { Send, Bot, User, Sparkles, Copy, Check, ClipboardPaste } from 'lucide-react';
          ...
          >
            ...
            <div style={{ maxWidth: '70%', position: 'relative' }}>
              <div style={{
                ...
                background: msg.role === 'user' ? 'rgba(59, 130, 246, 0.12)' : 'var(--color-bg-secondary)',
                border: `1px solid ${msg.role === 'user' ? 'rgba(59, 130, 246, 0.25)' : 'var(--color-border)'}`,
              ...
              <button
                ...
                style={{
                  ...
                  ...(msg.role === 'user' ? { left: '8px' } : { right: '8px' }),
                  background: 'var(--color-bg-secondary)', border: '1px solid var(--color-border)',
                  borderRadius: '50%', width: '28px', height: '28px', cursor: 'pointer',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  color: copiedId === i ? 'var(--color-success)' : 'var(--color-text-muted)',
