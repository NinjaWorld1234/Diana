...
const MOCK_GAMES = [
  ...
  {
    id: 'game-4',
    titleAr: 'تحدي حرق السعرات',
    type: 'CALORIES_BURN',
    node: { titleAr: 'الطاقة في التفاعلات الكيميائية' },
    description: 'احسب النشاط والمدة الزمنية اللازمة لحرق السعرات الحرارية في الوجبات المختلفة.',
    color: '#EF4444',
    icon: <Gamepad2 size={32} />,
        ...
        <div style={{ position: 'relative', width: '300px' }}>
          ...
          <input 
            ...
            style={{ 
              ...
              color: 'var(--color-text)', fontSize: '1rem', transition: 'all 0.2s',
              outline: 'none'
            }}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '24px' }}>
          {filteredGames.map((game, index) => (
            ...
            >
              ...
              <div style={{ 
                height: '160px', 
                background: game.image ? `url(${game.image}) center/cover no-repeat` : `linear-gradient(135deg, ${game.color}33, ${game.color}88)`,
